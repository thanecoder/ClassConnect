...
$query="insert into notice values ('','$branch','$sem','$tname','$topic','$desc','$filename','$date');";
if(mysqli_query($con,$query))
{
echo "<script type='text/javascript'>alert('Your notice has been sent to the students');</script>";
