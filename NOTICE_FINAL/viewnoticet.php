		...
		<div class='modal fade' tabindex='-1' id='confirm-lo'>
			<div class='modal-dialog modal-md'>
				<div class='modal-content'>
					...
					<center>
					<button type='button' class='btn btn-default btn-md' >Yes</button>
					&nbsp;&nbsp;&nbsp;
					...
					id='dynamicdiv'>
						<div class='modal-header' id='header' style='background-color: #CFD8DC; 
							...
							<div id='wrapper' style='width:100%; height:240px;'> 
								<div id='content'> 
	<p style='font-family:Cambria Math; font-size:20px; '>DESCRIPTION : $desc
</p>
								</div>
							</div>
							<br>
							<br>
							<p style='font-family:Cambria Math; font-size:20px; '>Files attached:$file</p>
							...
							<form method='post' action='downloadfile.php'id='downloadform'>
								...
								font-family:Cambria Math; font-size:20px; margin-top:-30px;'>
		...
		margin-left:210px; margin-top:90px; width:470px; max-height:540px;  '>
 				...
 				<div class='modal-content' style='height:540px;'>
					...
					<div style='width:470px; height:420px;  overflow:auto;'> 
							...
							echo"Date: ".$row2['date'];							$idnew=$row2['id'];
